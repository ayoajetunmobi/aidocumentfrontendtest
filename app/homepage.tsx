    ...
    return (
        <div>
            ...
            <div className="bg-amber-200 h-135 w-full lg:h-135 p-10  lg:block">
                <div onClick={(e)=>{switchHidSlide(e)}} className={`hidSlide transition-all duration-500 ease-in m-2 absolute left-1 md:left-70 h-110 w-55 md:w-70 pt-5 pl-10 pr-10 bg-linear-to-bl from-amber-700 to-amber-200 rounded-[20px] shadow-2xl`}>
                ...
                <div onClick={(e)=>{switchHidSlide(e)}} className={`hidSlide transition-all duration-500 ease-in m-2 absolute left-8 md:left-110 h-110 w-55 md:w-70 pt-5 pl-10 pr-10 bg-linear-to-bl from-amber-700 to-amber-200 rounded-[20px] shadow-2xl`}>
                    <FontAwesomeIcon className="border text-[1.3rem] p-2 rounded-[40px]"
                ...
                <div onClick={(e)=>{switchHidSlide(e)}} className={`hidSlide transition-all duration-500 ease-in m-2 absolute left-16 md:left-150 h-110 w-55 md:w-70 pt-5 pl-10 pr-10 bg-linear-to-bl from-amber-700 to-amber-200 rounded-[20px] shadow-2xl`}>
                    <FontAwesomeIcon className="border text-[1.3rem] p-2 rounded-[40px]"
                ...
                <div onClick={(e)=>{switchHidSlide(e)}} className={`hidSlide transition-all duration-500 ease-in m-2 absolute left-24 md:left-190 h-110 w-55 md:w-70 pt-5 pl-10 pr-10 bg-linear-to-bl from-amber-700 to-amber-200 rounded-[20px] shadow-2xl`}>
                    <FontAwesomeIcon className="border text-[1.3rem] p-2 rounded-[40px]"
                      icon={faMasksTheater}>
                    </FontAwesomeIcon>
